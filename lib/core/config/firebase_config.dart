class FirebaseConfig {
  ...
  // Note: The default Firebase Storage bucket name uses the appspot.com domain
  // even though requests are served from firebasestorage.app. Using
  // <project-id>.firebasestorage.app here will cause 404 upload/session errors.
  // See: https://firebase.google.com/docs/storage/flutter/start
  static const String androidStorageBucket = "lenv-cb08e.appspot.com";
  ...
  static const String webApiKey =
      "AIzaSyCsa_llQygftW7meLRGHbY66B1cJ-nzAFI"; // e.g. AIzaSy...
  ...
  static const String webStorageBucket =
      "lenv-cb08e.appspot.com"; // e.g. your-project.appspot.com
  static const String webMessagingSenderId = "527854850261"; // e.g. 1234567890
  ...
  static const String webMeasurementId =
      "G-YS604XE79C"; // optional (for analytics)
}

...
class _TeacherGroupChatPageState extends State<TeacherGroupChatPage>
  ...
  Future<void> _sendMessage({
    ...
    if (!hasInternet) {
      await _showOfflineSnackBar(
        isMedia: imageUrl != null || mediaMetadata != null,
      );
      return;
    }
                ...
                title: _isSelectionMode
                    ...
                    : GestureDetector(
                        onTap: () {
                          ...
                          final groupId =
                              '${widget.classId}_${widget.subjectId}';
                          // Start watching group DP
                          context.read<ProfileDPProvider>().watchGroupDP(
                            groupId,
                          );
                          Navigator.push(
                            context,
                        ...
                        return StreamBuilder<Timestamp?>(
                          ...
                          builder: (context, readSnapshot) {
                            ...
                            allMessages.removeWhere(
                              (msg) => _optimisticallyDeletedMessageIds
                                  .contains(msg.id),
                            );
  ...
  Widget _buildInputBar() {
    ...
    // Use the same visual structure as parent teacher-group input bar.
    final authProvider = Provider.of<AuthProvider>(context, listen: false);
    final currentUser = authProvider.currentUser;
    ...
    final borderWidth = isTeacher ? 1.6 : 1.2;
    final inputBgColor = isDark ? const Color(0xFF1E2024) : Colors.white;
    ...
    final iconColor = isTeacher
        ? const Color(0xFF355872)
        : (isDark ? const Color(0xFFFFB380) : const Color(0xFFFF8F00));
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  height: 42,
                  decoration: BoxDecoration(
                    color: isDark ? inputBgColor : Colors.white,
                    shape: BoxShape.circle,
                    border: Border.all(
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      ...
                      child: Icon(
                        Icons.attach_file,
                        color: _isUploading ? disabledIconColor : primaryColor,
                        size: 22,
                      ),
                    ),
                  ),

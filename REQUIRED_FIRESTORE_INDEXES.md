...
## testResults collection (Student results feed)
- Fields:
  - studentId (Ascending)
  - completedAt (Descending)

Create with this link (project `lenv-cb08e`):

- https://console.firebase.google.com/v1/r/project/lenv-cb08e/firestore/indexes?create_composite=Ck5wcm9qZWN0cy9sZW52LWNiMDhlL2RhdGFiYXNlcy8oZGVmYXVsdCkvY29sbGVjdGlvbkdyb3Vwcy90ZXN0UmVzdWx0cy9pbmRleGVzL18QARoNCglzdHVkZW50SWQQARoPCgtjb21wbGV0ZWRBdBACGgwKCF9fbmFtZV9fEAI
